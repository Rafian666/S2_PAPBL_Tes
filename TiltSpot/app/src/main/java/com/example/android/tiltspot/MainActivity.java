...
public class MainActivity extends AppCompatActivity
    ...
    private TextView label_p;
    private TextView label_r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        label_a = (TextView) findViewById(R.id.label_azimuth);
        mTextSensorAzimuth = (TextView) findViewById(R.id.value_azimuth);
        label_p = (TextView) findViewById(R.id.label_pitch);
        mTextSensorPitch = (TextView) findViewById(R.id.value_pitch);
        label_r = (TextView) findViewById(R.id.label_roll);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!mTextSensorAzimuth.getText().toString().isEmpty()) {
                    ...
                    try {
                        File gpxfile = new File(file, "Tilt_Spot_Data");
                        FileWriter writer = new FileWriter(gpxfile);
                        writer.append(label_a.getText().toString() +"\t:\t");
                        writer.append(mTextSensorAzimuth.getText().toString() +"\n");
                        writer.append(label_p.getText().toString() +"\t:\t");
                        writer.append(mTextSensorPitch.getText().toString() +"\n");
                        writer.append(label_r.getText().toString() +"\t:\t");
